...
import sobre from '../../public/sobre-mim.jpg'
...
export default async function Home() {
  ...
  return (
    <div className={`flex flex-col bg-zinc-950`}>
      ...
      <div
        id="sobre"
        className="flex items-center justify-center w-full h-screen m-auto max-w-7xl text-white p-4"
      >
        <div className="flex flex-col lg:flex-row items-center gap-10 mt-10">
          ...
          <div className="h-96 flex-1 flex w-full">
            <Image
              ...
              quality={100}
              alt=""
              className="border-t border-black w-full object-contain rounded-md"
            />
          </div>
        </div>
      </div>
